...
go-xserver 中框架层配置可以表现为下面的形式：
  ...
  - 配置结构体
    ...
    - [go-xserver/common/config/framework.go](go-xserver/common/config/framework.go)

  - 配置文件

    - [go-xserver/common/config/framework.toml](go-xserver/common/config/framework.toml)
