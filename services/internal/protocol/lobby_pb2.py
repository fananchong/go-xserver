...
_CMD_LOBBY_ENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MSGCMDOFFSET', index=5, number=4000,
      options=None,
      type=None),
  ],
